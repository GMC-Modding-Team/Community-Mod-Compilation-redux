# Goats of the Apocalypse (CDDA Mod)
...
## Install
1. Unzip into `Cataclysm-DDA/data/mods/`.
2. Enable **Goats of the Apocalypse** when creating a world.
...
## Changelog
- 0.4.3 – Added kid→adult upgrades via `into_group` after 180 days; rebuilt complete package.
